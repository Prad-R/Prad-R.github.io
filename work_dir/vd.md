...
In this project, I came up with a radial projection based adaptive sampling algorithm that allows computation of Voronoi diagrams for 3D spheres. This would be useful for optimal sensor location and protein structure studies. Benchmarks on the Voronota protein dataset have been run and have given accurate results.
